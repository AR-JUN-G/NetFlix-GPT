...
const Login=()=>{
    ...
    <>
        <div >
            ...
            <form className="w-3/12 p-14 absolute bg-black my-36 mx-auto right-0 left-0 text-white bg-opacity-80">
                <h1 className="font-bold text-3xl py-4 ">{isSignInForm?"Sign In":"Sign Up"}</h1>
                {!isSignInForm?<input type="text" placeholder="FullName" className="p-2 my-4 w-full rounded-sm bg-gray-700"/>:""}
                <input type="text" placeholder="Email Address" className="p-2 my-4 w-full rounded-sm bg-gray-700"/>
                <input type="password" placeholder="Password" className="p-2 my-4 w-full rounded-sm bg-gray-700"/>
                <button className="p-2 my-6 bg-red-700 w-full rounded-sm" >Submit</button>
